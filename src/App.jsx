...
const CONSTRUCT_REGISTER = [
  {
    ...
    reflection_question:
      "When something shakes my confidence — a setback, someone else's success, or criticism — what happens to how I see myself, and what helps me find my way back?",
    coaching_bridge:
    ...
    <div className="max-w-xl mx-auto px-6 py-16 sm:py-24">
      <div className="mb-10">
        ...
        <p className="mt-4 text-[#5A5646] leading-relaxed">
          ...
          to yourself — across success, mistakes, comparison and setbacks. Most people take 8–10 minutes.
        </p>
        <p className="mt-4 text-[#5A5646] leading-relaxed">
      ...
      <section className="page-break px-6 py-16 bg-[#E7E4D4]">
        <div className="max-w-xl mx-auto">
          ...
          <p className="mt-3 text-sm text-[#7A7563]">
            ...
            Position on the line does not indicate better or worse — only where your responses currently sit.
          </p>
              ...
              <div key={c.construct_id}>
                <div className="flex items-baseline justify-between mb-1.5">
                  ...
                  <span className="font-mono-brand text-sm text-[#5A5646]">
                    {scores[c.construct_id]?.value != null ? scores[c.construct_id].value.toFixed(1) : "—"}
                  </span>
                </div>
                <GroundLine
